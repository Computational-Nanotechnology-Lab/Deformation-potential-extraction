...
6) Convert g(matrix elements from EPW) to M using the expression: 𝑔_{𝜈𝑚⁢𝑛}⁡(𝐤,𝐪)= sqrt(ℏ/2⁢𝑚_0𝜔_{𝜈⁢𝐪})𝑀_{𝜈𝑚⁢𝑛}⁡(𝐤,𝐪), and plot the matrix elements. The code is present in g-M folder. Check which modes are polar.
